    ...
    <Card className="w-full relative overflow-hidden">
      <div className="p-4">
        ...
        <div
          ...
          ref={viewerRef}
          style={{ minHeight: 320, background: "#fff", borderRadius: "0.5rem" }}
        >
          {showImage && (
            <img
              src={imagePath}
...
//     case 1:
//     case "prosthetic":
//       return "/models/prosthetic_hand.stl";
//     case 2:
//     case "wheelchair":
//       return "/models/wheelchair.stl";
//     case 3:
...
//     case 4:
//     case "adaptive-utensil":
//       return "/models/adaptive_utensil.stl";
//     case 5:
//     case "vision-aid":
//       return "/models/vision_aid.stl";
//     case 6:
//     case "orthotic-insole":
//       return "/models/orthotic_insole.stl";
//     default:
//       return "/models/default.stl";
//   }
// };
...
//             modelPath,
//             (geometry) => {
//               const material = new THREE.MeshStandardMaterial({ color: 0xcccccc, metalness: 0.3, roughness: 0.6 });
//               const mesh = new THREE.Mesh(geometry, material);
//               scene.add(mesh);
//               // Center and scale
//               geometry.computeBoundingBox();
